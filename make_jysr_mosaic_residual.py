...
for filename in ProgressBar(glob.glob(os.path.expanduser("~/Dropbox/CMZoom_Data/continuum_images/Residuals/[GS]*fits"))):
...
outheader['CRPIX1'] = 9500
outheader['CRPIX2'] = 1400
